...
To minimize the footprint further, a range of ideas was considered, see `Python minimization in Fedora`_. These ideas have been then discussed on this `Fedora devel mailing list thread`_. XXX TODO list all ideas and why we rejected them

Compressing ``.pyc`` bytecode files (slower startup due to decompression): https://bugs.python.org/issue22789

XXX TODO Add trimming stdlib as outside of the scope
